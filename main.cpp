...
constexpr const char* studentID = "109511097";
...
int main() {
    ...
    // Load data from assets
    {
        ...
        auto jelly1 = std::make_shared<gfx::Texture>(pf::find("Texture/spongebob_side.png"));
        auto jelly2 = std::make_shared<gfx::Texture>(pf::find("Texture/spongebob_side.png"));
        auto jelly3 = std::make_shared<gfx::Texture>(pf::find("Texture/spongebob_side.png"));
        auto jelly4 = std::make_shared<gfx::Texture>(pf::find("Texture/spongebob_side.png"));
        auto jelly5 = std::make_shared<gfx::Texture>(pf::find("Texture/spongebob_side.png"));
        auto jelly6 = std::make_shared<gfx::Texture>(pf::find("Texture/spongebob_side.png"));
        auto jelly6_face = std::make_shared<gfx::Texture>(pf::find("Texture/spongebob_face.png"));
        auto jelly6_collision = std::make_shared<gfx::Texture>(pf::find("Texture/spongebob_collision.png"));
        ...
        g_jelly->setFaceTextures({jelly1, jelly2, jelly3, jelly4, jelly5, jelly6_face});
        g_jelly->setCollisionTextures({jelly1, jelly2, jelly3, jelly4, jelly5, jelly6_collision});
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        if (particleSystem.isSimulating) {
            if (effect1) {
                if (particleSystem.hasStrongCollision) {
                    g_jelly->changeCollisionTextures();
                } else {
                    g_jelly->changeNormalTextures();
                }
            } else {
                g_jelly->changeTextures();
            }

            if (effect2) {
                double t = glfwGetTime();
                particleSystem.updateTerrainPose(t);
                PlaneTerrainGraphics->updatePose(particleSystem.getPlaneTerrainPose());
                BowlTerrainGraphics->updatePose(particleSystem.getBowlTerrainPose());
            }

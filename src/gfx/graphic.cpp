...
void Rigidbody::updatePose(Eigen::Vector3f pose) { modelMatrix.col(3).head<3>() << pose; }
...
void SoftJelly::setTextures(const std::array<std::shared_ptr<Texture>, 6>& _textures) { textures = normal_textures = _textures; }
void SoftJelly::setFaceTextures(const std::array<std::shared_ptr<Texture>, 6>& _textures) { face_textures = _textures; }
void SoftJelly::setCollisionTextures(const std::array<std::shared_ptr<Texture>, 6>& _textures) { collision_textures = _textures; }

void SoftJelly::changeTextures() { textures = normal_textures; }
void SoftJelly::changeCollisionTextures() { textures = collision_textures; }
void SoftJelly::changeNormalTextures() { textures = face_textures; }

...
class Rigidbody {
 public:
    ...
    void updatePose(Eigen::Vector3f pose);
...
class SoftJelly final {
 private:
    ...
    std::array<std::shared_ptr<Texture>, 6> normal_textures;
    std::array<std::shared_ptr<Texture>, 6> collision_textures;
    std::array<std::shared_ptr<Texture>, 6> face_textures;
 ...
 public:
    ...
    void setFaceTextures(const std::array<std::shared_ptr<Texture>, 6>& _textures);
    void setCollisionTextures(const std::array<std::shared_ptr<Texture>, 6>& _textures);
    void changeTextures();
    void changeCollisionTextures();
    void changeNormalTextures();
